...
func CollectRoutes(r *gin.Engine) *gin.Engine {
	...
	api.POST("/upload/rich_editor_upload", controller.RichEditorUpload)
	// 用户信息管理
	...
	// 查询分类
	api.GET("/category", controller.SearchCategory)         // 查询分类
	api.GET("/category/:id", controller.SearchCategoryName) // 查询分类名
	//用户文章的增删查改
