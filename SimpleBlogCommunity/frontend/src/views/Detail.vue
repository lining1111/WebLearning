<template>
  ...
  <div class="tabs">
    <n-card>
      ...
      <n-divider/>
      <n-button v-if=!collected text @click="newCollect"
                style="position: absolute; right: 40px; top: 25px; cursor: pointer;" round ghost color="#FFA876">
        <template #icon>
          <n-icon>
            <star-outline/>
          </n-icon>
      ...
      <n-button v-else text @click="unCollect" style="position: absolute; right: 40px; top: 25px; cursor: pointer;"
                round ghost color="#FFA876">
        <template #icon>
          <n-icon>
            <star/>
          </n-icon>
...
const articleInfo = ref<ArticleInfo | null>()
